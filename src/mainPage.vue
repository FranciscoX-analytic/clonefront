        ...
        items: [
          {
            ...
            icon: "pi pi-fw pi-database",
            items: [
              { label: "Submenu 1.1.1", icon: "pi pi-fw pi-database" },
              { label: "Submenu 1.1.2", icon: "pi pi-fw pi-database" },
              { label: "Submenu 1.1.3", icon: "pi pi-fw pi-database" },
            ],
          },
          {
            label: "Submenu 1.2",
            icon: "pi pi-fw pi-database",
            items: [
              { label: "Submenu 1.2.1", icon: "pi pi-fw pi-database" },
              { label: "Submenu 1.2.2", icon: "pi pi-fw pi-database" },
            ],
          },
        ],
      },
        ...
        items: [
          {
            ...
            icon: "pi pi-fw pi-database",
            items: [
              { label: "Submenu 2.1.1", icon: "pi pi-fw pi-database" },
              { label: "Submenu 2.1.2", icon: "pi pi-fw pi-database" },
              { label: "Submenu 2.1.3", icon: "pi pi-fw pi-database" },
            ],
          },
          {
            label: "Submenu 2.2",
            icon: "pi pi-fw pi-database",
            items: [
              { label: "Submenu 2.2.1", icon: "pi pi-fw pi-database" },
              { label: "Submenu 2.2.2", icon: "pi pi-fw pi-database" },
            ],
          },
        ],
      },
